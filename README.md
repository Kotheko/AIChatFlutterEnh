...
1. **Главная страница (Chat)** - `lib/screens/chat_screen.dart`
   ...
   ![Chat Screen](https://cloud.mail.ru/public/JFT7/LTh4Hz4V1)
...
2. **Настройки (Settings)** - вкладка в `lib/screens/chat_screen.dart` (метод `_buildSettingsPage()`)
   ...
   ![Settings Screen](https://cloud.mail.ru/public/AQrC/X8hhmwG4C)
...
3. **Статистика (Statistics)** - `lib/screens/statistics_screen.dart`
   ...
   ![Statistics Screen](https://cloud.mail.ru/public/mjVh/pTiTw8tNb)
...
4. **Расходы (Expenses)** - `lib/screens/expenses_screen.dart`
   ...
   ![Expenses Screen](https://cloud.mail.ru/public/mRMb/rrbct1sWb)
